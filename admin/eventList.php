				...
				<tbody>
					<?php while ($row = mysqli_fetch_assoc($result)) : ?>
						<tr>                                   
							...
							<td>                                
								<a href="eventView.php?id=<?php echo $row->event_id; ?>"><button class="btn btn-success">View</button></a>
								<a href="book-edit.php?id=<?php echo $book->id; ?>"><button class="btn btn-info">Edit</button></a>
								<a href="book-del.php?id=<?php echo $book->id; ?>"><button class="btn btn-danger">Delete</button></a>
							</td>
						</tr>
					<?php endwhile ?>
				</tbody>
